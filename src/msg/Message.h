...
public:
  // zipkin tracing
  ZTracer::Trace trace;
  void encode_trace_jaeger(ceph::buffer::list &bl, uint64_t features, jspan& parent_span) const;
  ...
  void decode_trace_jaeger(ceph::buffer::list::const_iterator &p, bool create = false, std::string t_meta="t_meta");
